...
(function() {
  'use strict';
  var CND, PD, Re2, badge, debug, echo, help, info, is_valid_Re2, jr, match_against_re, match_against_re2, rpr, sre_1, sre_2, test, to_width, urge, warn, whisper, width_of;
  ...
  this["basic"] = async function(T, done) {
    ...
    probes_and_matchers = [[['simple', /[aeiou][^aeiou]/], [true, true]], [['PD/datom', PD._datom_keypattern], [true, true]], [['PD/selector', PD._selector_keypattern], [true, true]], [['PD/tag', PD._tag_pattern], [true, true]], [['x1', /(a+)+$/], [false, true]], [['x2', /(beep|boop)*/], [true, true]], [['x3', /\blocation\s*:[^:\n]+\b(Oakland|San Francisco)\b/], [true, true]], [['x4', /(x+x+)+y/], [false, true]], [['x5', /(a+){10}/], [false, true]], [['x6', /(a+){10}y/], [false, true]]];
//.........................................................................................................
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      [probe, matcher, error] = probes_and_matchers[i];
      await T.perform(probe, matcher, error, function() {
        return new Promise(function(resolve, reject) {
          ...
          is_safe = (sre_1(pattern)) && (sre_2(pattern));
  ...
  if (module.parent == null) {
    // test @
    test(this["regex performance, runaway test"]);
  }
